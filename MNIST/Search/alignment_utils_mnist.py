...
class bottom_up:
    ...
    def find_sequence(self,image):
        ...
        angles = self.threshold_angle_on_distance(angles,dists,threshold=22)
        conn = self.get_connection_table_angle_thresholded(angles,a_tolerance= 10)
